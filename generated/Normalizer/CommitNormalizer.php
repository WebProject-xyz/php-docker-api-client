...
class CommitNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \WebProject\DockerApi\Library\Generated\Model\Commit::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && \WebProject\DockerApi\Library\Generated\Model\Commit::class === get_class($data);
    }
    ...
    {
        return [\WebProject\DockerApi\Library\Generated\Model\Commit::class => true];
    }
