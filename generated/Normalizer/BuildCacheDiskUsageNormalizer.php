...
class BuildCacheDiskUsageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \WebProject\DockerApi\Library\Generated\Model\BuildCacheDiskUsage::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && \WebProject\DockerApi\Library\Generated\Model\BuildCacheDiskUsage::class === get_class($data);
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \WebProject\DockerApi\Library\Generated\Model\BuildCacheDiskUsage();
    ...
    {
        return [\WebProject\DockerApi\Library\Generated\Model\BuildCacheDiskUsage::class => true];
    }
